Contributing to GHRCoin
============================

The GHRCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the GHRCoin project, and is not to be
confused with overall GHRCoin Network Protocol consensus changes.

Whether a pull request is merged into GHRCoin rests with the project merge
...
Patches that change GHRCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the GHRCoin consensus, it must have been
...
The project leader is the release manager for each GHRCoin release.
