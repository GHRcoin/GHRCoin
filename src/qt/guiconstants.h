...
/* GHRCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GHRCoin"
#define QAPP_ORG_DOMAIN "ghrcoin.org"
#define QAPP_APP_NAME_DEFAULT "GHRCoin-Qt"
#define QAPP_APP_NAME_TESTNET "GHRCoin-Qt-testnet"
