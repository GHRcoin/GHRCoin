                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zGHR || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending GHR because you wouldn't check it anyway.
    if (context == Context::Send_GHR || context == Context::Send_zGHR) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("GHRCoin will close now to finish the encryption process. "
