...
/** Utility functions used by the GHRCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render GHRCoin addresses in monospace font
...
// Parse "ghrcoin:" URI into recipient object, return true on successful parsing
