...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GHRCoin ghrcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ghrcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ghrcoin transaction") + "\n" +
                               "  ghrcoin-tx [options] -create [commands]   " + _("Create hex-encoded ghrcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ghrcoin transaction
