...
In order to support loading of multiple wallets in ghrcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ghrcoin.cpp.
...
Changes to ghrcoin.cpp
----------------------
ghrcoin.cpp is the entry point into ghrcoin-qt, and as such, will require some minor modifications to provide hooks for
