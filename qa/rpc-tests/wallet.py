...
#   c) node1 mines 32 blocks, so now node 0 has 60001ghr, node 1 has 4250ghr, node2 has none.
#   d) node0 sends 601 ghr to node2, in two transactions (301 ghr, then 300 ghr).
