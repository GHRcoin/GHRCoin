...
RESOURCES += src/qt/ghrcoin.qrc src/qt/ghrcoin_locale.qrc

TRANSLATIONS += src/qt/locale/ghrcoin_bg.ts \
                src/qt/locale/ghrcoin_de.ts \
                src/qt/locale/ghrcoin_en.ts \
                src/qt/locale/ghrcoin_es.ts \
                src/qt/locale/ghrcoin_fi.ts \
                src/qt/locale/ghrcoin_fr.ts \
                src/qt/locale/ghrcoin_it.ts \
                src/qt/locale/ghrcoin_ja.ts \
                src/qt/locale/ghrcoin_pl.ts \
                src/qt/locale/ghrcoin_pt.ts \
                src/qt/locale/ghrcoin_ru.ts \
                src/qt/locale/ghrcoin_sk.ts \
                src/qt/locale/ghrcoin_sv.ts \
                src/qt/locale/ghrcoin_vi.ts \
                src/qt/locale/ghrcoin_zh_CN.ts \
                src/qt/locale/ghrcoin_zh_TW.ts
